...
import { WA_NUMBER, WA_URL, FACEBOOK_URL, CONTACT_EMAIL, ADDRESS } from "@/lib/constants";
    ...
    <footer className="bg-brand-navy">
      ...
      <div className="mx-auto max-w-5xl px-6 py-16">
          ...
          <div className="flex flex-col gap-5 sm:col-span-2 md:col-span-1">
            ...
            <div className="flex items-center gap-4">
              <a
                ...
                className="text-white/50 transition-colors duration-200 hover:text-brand-gold"
              >
        ...
        <div className="mt-14 flex flex-col items-center justify-between gap-2 border-t border-white/10 pt-6 sm:flex-row">
          ...
          <p className="text-xs text-white/35">aditmex.com.mx</p>
        </div>
      </div>
    </footer>
  );
