...
const CARDS = [
  {
    key: "alimentos",
    src: "/assets/images/lacteos-pan-dulces.avif",
  ...
  return (
    ...
    >
      ...
      <div className="mx-auto max-w-5xl">
        ...
        <div
          ref={gridRef}
          className="grid auto-rows-[210px] grid-cols-2 gap-3 md:auto-rows-[160px] md:grid-cols-3 lg:auto-rows-[175px] xl:auto-rows-[190px]"
        >
          {CARDS.map((card) => (
            <div
              key={card.key}
